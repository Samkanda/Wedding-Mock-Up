...
const About = () => {
  return (
    <div className="About-Container pt-10 sm:pt-24 ">
    <div className="About-Box w-7/12 p-12 border-2">
        <h2 className="sm:mb-4 self-end box-title py-1 rounded-md font-bold">ABOUT US</h2>
        <h1 className='sm:hidden text-primary text-5xl'>Interior design that matters</h1>
        <h1 className=' hidden sm:flex text-primary text-5xl sm:text-6xl md:text-7xl w-max'>Interior design</h1>
        <h1 className=' aa hidden sm:flex text-primary text-5xl sm:text-6xl md:text-7xl w-max'>that matters</h1>
        <div className='subtitle self-end row-start-3 sm:row-start-5'>
